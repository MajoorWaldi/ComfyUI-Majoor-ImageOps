...
import { blendChannel01 as blendChannel012 } from "../shared/blend-modes.js";
...
function composite(ctx, W, node, inputs) {
  const base = inputs[0] ?? ctx.canvas;
...
function comp(ctx, W, node, inputs) {
...
export {
  applyGlow,
  blend,
  blendChannel012 as blendChannel01,
  blendOps,
  comp,
  compModeToCanvasOp,
  composite,
