...
function computeScopes(imageData, opts) {
...
function drawHistogram(ctx, W, H, hist) {
...
function drawWaveform(ctx, W, H, wf, wfW, wfH) {
  ctx.setTransform(1, 0, 0, 1, 0, 0);
  ctx.clearRect(0, 0, W, H);
  ctx.fillStyle = "rgba(0,0,0,0.35)";
  ctx.fillRect(0, 0, W, H);
...
function drawRgbWaveform(ctx, W, H, wr, wg, wb, wfW, wfH) {
  ctx.setTransform(1, 0, 0, 1, 0, 0);
  ctx.clearRect(0, 0, W, H);
  ctx.fillStyle = "rgba(0,0,0,0.35)";
  ctx.fillRect(0, 0, W, H);
...
function drawVectorscope(ctx, S, data, size) {
  ctx.setTransform(1, 0, 0, 1, 0, 0);
