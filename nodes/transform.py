    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "rotate_deg": ("FLOAT", {"default": 0.0, "min": -180.0, "max": 180.0, "step": 0.1, "round": 0.001}),
                "scale": ("FLOAT", {"default": 1.0, "min": 0.01, "max": 8.0, "step": 0.01, "round": 0.001}),
                "flip": (["none", "horizontal", "vertical"], {"default": "none"}),
                "filter": (["nearest", "bilinear", "bicubic"],),
                "expand": ("BOOLEAN", {"default": False,
                                        "tooltip": "Reserved. Currently inactive — the GPU affine path uses a fixed-size canvas. Kept for workflow compatibility."}),
